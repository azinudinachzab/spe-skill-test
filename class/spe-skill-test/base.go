...
func NarcissisticNumber(num int64) bool {
...
func ParityOutlier(arr []int64) (int64,bool) {
	oddArr := make([]int64, 0)
...
func NeedleInAHaystack(arr []string, keyword string) int {
...
func TheBlueOceanReverse(arr1, arr2 []int64) []int64 {
	arrRes := make([]int64,0)
